...
const niftyDir = './src/files/nifty_files';
const sbinDir = './src/files/sbin_files';
...
function fetchData() {
    ...
    try {
        fs.writeFileSync('./src/tokens.json', JSON.stringify(tokens, null, 2)); // Update tokens.json
    } catch (error) {
